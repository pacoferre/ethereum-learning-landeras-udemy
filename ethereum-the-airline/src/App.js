    ...
    async componentDidMount() {
        ...
        flightPurchased.watch(function (err, result) {
            ...
            if (customer === this.state.account) {
                console.log(`Your purchased a flight to ${flight} with a cost of ${this.toEther(price)} eth`);
            } else {
                this.container.success(`Last customer purchased a flight to ${flight} with a cost of ${this.toEther(price)} eth`,
                    'Flight information');
            } 
        }.bind(this));
                ...
                <div className="col-sm">
                    <Panel title="Loyalty points - refundable ether">
                        ...
                        <button className="btn btn-sm btn-success text-white" 
                            onClick={this.redeemLoyaltyPoints.bind(this)}>Refund</button>
                    </Panel>
                </div>
            </div>
            <div className="row">
                    ...
                    <Panel title="Available flights">
                        {this.state.flights.map((flight, i) => {
                            return <div key={i}>
                                ...
                                <button className="btn btn-sm btn-success text-white"
                                    onClick={() => this.buyFlight(i, flight)}>Purchase</button>
                            </div>
                        })}
                    </Panel>
                </div>
